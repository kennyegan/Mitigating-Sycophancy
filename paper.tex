...
\begin{enumerate}
    ...
    \item \textbf{DPO reduces in-distribution opinion sycophancy by 23.8\,pp while preserving capabilities.} Fine-tuning with 360 training pairs (from 400 generated, 40 held for validation) reduces opinion sycophancy from 82.4\% to 58.6\%---a substantial reduction but still above 50\%. MMLU +0.8\,pp; GSM8k preserved (38.5\%, $N{=}200$, 95\% CI overlapping baseline). Out-of-distribution generalization remains untested.

#!/bin/bash
#SBATCH --job-name=syc-dpo-s300
#SBATCH --output=slurm/logs/dpo_seed300_%j.out
#SBATCH --error=slurm/logs/dpo_seed300_%j.err
...
# with seed=300 for multi-seed robustness.
#
# Step 1: DPO fine-tune with 400 opinion pairs (seed=300, disjoint from benchmark)
#         LoRA rank 16, alpha 32, q/k/v/o projections
#         DPO beta=0.1, lr=5e-5, cosine schedule, 3 epochs
#         Output: results/dpo_model_seed300/
#
...
#         Output: results/dpo_eval_seed300.json
#
...
echo "============================================"
echo "SLURM Job: DPO Seed 300 — Training"
echo "Model: ${PRIMARY_MODEL}"
echo "Train pairs: 400"
echo "Seed: 300 (disjoint from benchmark seed=42)"
echo "Epochs: 3"
echo "Node: $(hostname)"
...
python scripts/06_dpo_training.py \
    ...
    --n-train-pairs 400 \
    --seed 300 \
    --output-dir results/dpo_model_seed300 \
    --epochs 3 \
    --lr 5e-5 \
    --lora-rank 16 \
    --batch-size 4 \
...
echo "============================================"
echo "DPO training (seed=300) complete: $(date)"
...
echo "============================================"
echo "DPO seed=300 pipeline complete: $(date)"
echo "Results: results/dpo_eval_seed300.json"
echo "============================================"
